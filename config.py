...
def asc_config(parser):
    ...
    parser.add_argument('--ntasks',default=6,type=int,required=False,help='(default=%(default)d)')
    ...
    parser.add_argument('--save_model',type=str,default='yes',help='(default=%(default)d)')
    parser.add_argument('--multi_mask',type=int,default=1,help='for random mask only')
    parser.add_argument("--num_task", default=24, type=float,
                        help="Max gradient norm.")
    parser.add_argument('--dropout_rate', type=float, default=0.5,
                        help='baseline normal dropout rate')
    parser.add_argument('--mask_rate', type=float, default=0.5,
                        help='rate of mask')
    parser.add_argument('--mask_rate_min', type=float, default=0.1,
                        help='rate of min mask')
    parser.add_argument('--mask_rate_max', type=float, default=0.6,
                        help='rate of max mask')

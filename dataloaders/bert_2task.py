...
def get(logger=None,args=None):
    if args.two_task!='yes' and os.path.exists('./dat/bin/data_dis6'+'_'+str(args.idrandom)+'.pt') and os.path.exists('./dat/bin/taskcla_dis6'+'_'+str(args.idrandom)+'.pt'):
    ...
    for t in range(1):
        ...
        dataset2=datasets[domains.index(random_sep[t+1])]
        data[t]={}
        data[t]['name']=dataset
        data[t]['ncla']=2
        # if 'Bing' in dataset:
        ...
        train_examples = processor.get_train_examples(dataset)+processor.get_train_examples(dataset2)
        ...
        valid_examples = processor.get_dev_examples(dataset)+processor.get_dev_examples(dataset2)
        ...
        eval_examples = processor.get_test_examples(dataset)+processor.get_test_examples(dataset2)

...
datasets = [
    ...
    './dat/dsc_json/Z_MultiData',
    './dat/dsc_json/Z_Similar_Data',
    './dat/dsc_json/Z_Dissimilar_Data'
            ]
...
def get(logger=None,args=None):
    if os.path.exists('./dat/bin/data_joint_dis6'+'_'+str(args.idrandom)+'.pt') and os.path.exists('./dat/bin/taskcla_joint_dis6'+'_'+str(args.idrandom)+'.pt'):
        data=torch.load('./dat/bin/data_joint_dis6'+'_'+str(args.idrandom)+'.pt')
        taskcla=torch.load('./dat/bin/taskcla_joint_dis6'+'_'+str(args.idrandom)+'.pt')
        return data,taskcla
    data={}
    taskcla=[]

    # Others
    f_name = 'asc_random_dis_joint'
    ...
    torch.save(data,'./dat/bin/data_joint_dis6'+'_'+str(args.idrandom)+'.pt')
    torch.save(taskcla,'./dat/bin/taskcla_joint_dis6'+'_'+str(args.idrandom)+'.pt')
    return data,taskcla
